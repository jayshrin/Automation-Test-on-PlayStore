...
public class test{
	...
	public void musicPlay() throws IOException, BiffException {
    	...
    	driver.findElement(By.id("com.android.vending:id/creator_image")).click();
    	driver.findElement(By.id("com.android.vending:id/status_indicator")).click();
