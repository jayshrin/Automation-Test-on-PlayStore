...
public class test{
	...
	driver.findElement(By.id("com.android.vending:id/text_container")).click();
    	driver.findElement(By.id("com.android.vending:id/text_container")).sendKeys("linkedin student");
